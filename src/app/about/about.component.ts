...
export class AboutComponent implements OnInit {
  ...
  ngOnInit(): void {
    let request = 'https://swapi.dev/api/planets/1/';
    let residents = 'https://swapi.dev/api/people/?page=1';
    let residentsPageTwo = 'https://swapi.dev/api/people/?page=2';
    let residentsPageThree = 'https://swapi.dev/api/people/?page=5';
    let residentsPageFour = 'https://swapi.dev/api/people/?page=7';
    ...
    containerDescriptionTwo.classList.add('card-resident', 'na');
    containerDescriptionThree.classList.add('card-resident', 'male');
    containerDescriptionFour.classList.add('card-resident', 'male');
    containerDescriptionFive.classList.add('card-resident', 'female');
    containerDescriptionSix.classList.add('card-resident', 'na');
    containerDescriptionSeven.classList.add('card-resident', 'male');
    containerDescriptionEight.classList.add('card-resident', 'male');
    containerDescriptionNine.classList.add('card-resident', 'female');
    containerDescriptionTen.classList.add('card-resident', 'male');
    ...
    imgResidentOne.src = '../assets/img/resident/luke.webp';
    ...
    imgResidentTwo.src = '../assets/img/resident/3PONaked.jpg';
    ...
    imgResidentThree.src = '../assets/img/resident/darth-vader.jpg';
    ...
    imgResidentFour.src = '../assets/img/resident/owen.webp';
    ...
    imgResidentFive.src = '../assets/img/resident/bonnie.webp';
    ...
    imgResidentSix.src = '../assets/img/resident/R5d4.webp';
    ...
    imgResidentSeven.src = '../assets/img/resident/biggsHS.webp';
    ...
    imgResidentEight.src = '../assets/img/resident/anakin.jpg';
    ...
    imgResidentNine.src = '../assets/img/resident/shmi_skywalker.webp';
    ...
    imgResidentTen.src = '../assets/img/resident/schneider.webp';
    ...
    fetch(residents).then((response) => {
      ...
      let namePerson = namePersonOne.innerHTML = JSON.stringify(data.results[0].name)
      let my_namePersonOne = JSON.parse(namePerson);
      namePersonOne.innerHTML = my_namePersonOne;

      let heightPerson = heightPersonOne.innerHTML = JSON.stringify(data.results[0].height)
      let my_heightPersonOne = JSON.parse(heightPerson);
      heightPersonOne.innerHTML = my_heightPersonOne + ' ' + 'cm';

      let massPerson = massPersonOne.innerHTML = JSON.stringify(data.results[0].mass)
      let my_massPersonOne = JSON.parse(massPerson);
      massPersonOne.innerHTML = my_massPersonOne + ' ' + 'kg';

      let hairPerson = hairPersonOne.innerHTML = JSON.stringify(data.results[0].hair_color)
      let my_hairPersonOne = JSON.parse(hairPerson);
      hairPersonOne.innerHTML = my_hairPersonOne;

      let skinPerson = skinPersonOne.innerHTML = JSON.stringify(data.results[0].skin_color)
      let my_skinPersonOne = JSON.parse(skinPerson);
      skinPersonOne.innerHTML = my_skinPersonOne;

      let eyePerson = eyePersonOne.innerHTML = JSON.stringify(data.results[0].eye_color)
      let my_eyePersonOne = JSON.parse(eyePerson);
      eyePersonOne.innerHTML = my_eyePersonOne;

      let yearPerson = yearPersonOne.innerHTML = JSON.stringify(data.results[0].birth_year)
      let my_yearPersonOne = JSON.parse(yearPerson);
      yearPersonOne.innerHTML = my_yearPersonOne;

      let genderPerson = genderPersonOne.innerHTML = JSON.stringify(data.results[0].gender)
    ...
    fetch(residents).then((response) => {
      ...
      let namePersonTwos = namePersonTwo.innerHTML = JSON.stringify(data.results[1].name)
      let my_namePersonTwo = JSON.parse(namePersonTwos);
      namePersonTwo.innerHTML = my_namePersonTwo;

      let heightPersonTwos = heightPersonTwo.innerHTML = JSON.stringify(data.results[1].height)
      let my_heightPersonTwo = JSON.parse(heightPersonTwos);
      heightPersonTwo.innerHTML = my_heightPersonTwo + ' ' + 'cm';

      let massPersonTwos = massPersonTwo.innerHTML = JSON.stringify(data.results[1].mass)
      let my_massPersonTwo = JSON.parse(massPersonTwos);
      massPersonTwo.innerHTML = my_massPersonTwo + ' ' + 'kg';

      let hairPersonTwos = hairPersonTwo.innerHTML = JSON.stringify(data.results[1].hair_color)
      let my_hairPersonTwo = JSON.parse(hairPersonTwos);
      hairPersonTwo.innerHTML = my_hairPersonTwo;

      let skinPersonTwos = skinPersonTwo.innerHTML = JSON.stringify(data.results[1].skin_color)
      let my_skinPersonTwo = JSON.parse(skinPersonTwos);
      skinPersonTwo.innerHTML = my_skinPersonTwo;

      let eyePersonTwos = eyePersonTwo.innerHTML = JSON.stringify(data.results[1].eye_color)
      let my_eyePersonTwo = JSON.parse(eyePersonTwos);
      eyePersonTwo.innerHTML = my_eyePersonTwo;

      let yearPersonTwos = yearPersonTwo.innerHTML = JSON.stringify(data.results[1].birth_year)
      let my_yearPersonTwo = JSON.parse(yearPersonTwos);
      yearPersonTwo.innerHTML = my_yearPersonTwo;

      let genderPersonTwos = genderPersonTwo.innerHTML = JSON.stringify(data.results[1].gender)
    ...
    fetch(residentsPageThree).then((response) => {
      ...
      let namePersons = namePerson.innerHTML = JSON.stringify(data.results[1].name)
      let my_namePerson = JSON.parse(namePersons);
      namePerson.innerHTML = my_namePerson;

      let heightPersons = heightPerson.innerHTML = JSON.stringify(data.results[1].height)
      let my_heightPerson = JSON.parse(heightPersons);
      heightPerson.innerHTML = my_heightPerson + ' ' + 'cm';

      let massPersons = massPerson.innerHTML = JSON.stringify(data.results[1].mass)
      let my_massPerson = JSON.parse(massPersons);
      massPerson.innerHTML = my_massPerson + ' ' + 'kg';

      let hairPersons = hairPerson.innerHTML = JSON.stringify(data.results[1].hair_color)
      let my_hairPerson = JSON.parse(hairPersons);
      hairPerson.innerHTML = my_hairPerson;

      let skinPersons = skinPerson.innerHTML = JSON.stringify(data.results[1].skin_color)
      let my_skinPerson = JSON.parse(skinPersons);
      skinPerson.innerHTML = my_skinPerson;

      let eyePersons = eyePerson.innerHTML = JSON.stringify(data.results[1].eye_color)
      let my_eyePerson = JSON.parse(eyePersons);
      eyePerson.innerHTML = my_eyePerson;

      let yearPersons = yearPerson.innerHTML = JSON.stringify(data.results[1].birth_year)
      let my_yearPerson = JSON.parse(yearPersons);
      yearPerson.innerHTML = my_yearPerson;

      let genderPersons = genderPerson.innerHTML = JSON.stringify(data.results[1].gender)
      let my_genderPerson = JSON.parse(genderPersons);
      genderPerson.innerHTML = my_genderPerson;
