...
@Component({
  selector: 'app-about-bespin',
  templateUrl: '../about/about.component.html',
  styleUrls: ['../about/about.component.css']
})
export class AboutBespinComponent implements OnInit {

  constructor() { }

  ngOnInit(): void {
    let request = 'https://swapi.dev/api/planets/6/';
    ...
    imgResidentOne.src = '../assets/img/resident/lobot.webp';
