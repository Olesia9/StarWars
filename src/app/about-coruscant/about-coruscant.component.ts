...
@Component({
  selector: 'app-about-coruscant',
  templateUrl: '../about/about.component.html',
  styleUrls: ['../about/about.component.css']
})
export class AboutCoruscantComponent implements OnInit {

  constructor() { }

  ngOnInit(): void {
    let request = 'https://swapi.dev/api/planets/9/';
    let residents = 'https://swapi.dev/api/people/?page=4';
    let residentsPageTwo = 'https://swapi.dev/api/people/?page=6';
    let residentsPageThree = 'https://swapi.dev/api/people/?page=8';
    ...
    containerDescriptionTwo.classList.add('card-resident', 'female');
    ...
    imgResidentOne.src = '../assets/img/resident/valorum.jpg';
    ...
    imgResidentTwo.src = '../assets/img/resident/adi.webp';
    ...
    imgResidentThree.src = '../assets/img/resident/jocasta.webp';
    ...
    fetch(residentsPageTwo).then((response) => {
      ...
      let namePersonTwos = namePersonTwo.innerHTML = JSON.stringify(data.results[3].name)
      let my_namePersonTwo = JSON.parse(namePersonTwos);
      namePersonTwo.innerHTML = my_namePersonTwo;

      let heightPersonTwos = heightPersonTwo.innerHTML = JSON.stringify(data.results[3].height)
      let my_heightPersonTwo = JSON.parse(heightPersonTwos);
      heightPersonTwo.innerHTML = my_heightPersonTwo + ' ' + 'cm';

      let massPersonTwos = massPersonTwo.innerHTML = JSON.stringify(data.results[3].mass)
      let my_massPersonTwo = JSON.parse(massPersonTwos);
      massPersonTwo.innerHTML = my_massPersonTwo + ' ' + 'kg';

      let hairPersonTwos = hairPersonTwo.innerHTML = JSON.stringify(data.results[3].hair_color)
      let my_hairPersonTwo = JSON.parse(hairPersonTwos);
      hairPersonTwo.innerHTML = my_hairPersonTwo;

      let skinPersonTwos = skinPersonTwo.innerHTML = JSON.stringify(data.results[3].skin_color)
      let my_skinPersonTwo = JSON.parse(skinPersonTwos);
      skinPersonTwo.innerHTML = my_skinPersonTwo;

      let eyePersonTwos = eyePersonTwo.innerHTML = JSON.stringify(data.results[3].eye_color)
      let my_eyePersonTwo = JSON.parse(eyePersonTwos);
      eyePersonTwo.innerHTML = my_eyePersonTwo;

      let yearPersonTwos = yearPersonTwo.innerHTML = JSON.stringify(data.results[3].birth_year)
      let my_yearPersonTwo = JSON.parse(yearPersonTwos);
      yearPersonTwo.innerHTML = my_yearPersonTwo;

      let genderPersonTwos = genderPersonTwo.innerHTML = JSON.stringify(data.results[3].gender)
    ...
    fetch(residentsPageThree).then((response) => {
      ...
      let namePersons = namePerson.innerHTML = JSON.stringify(data.results[2].name)
      let my_namePerson = JSON.parse(namePersons);
      namePerson.innerHTML = my_namePerson;

      let heightPersons = heightPerson.innerHTML = JSON.stringify(data.results[2].height)
      let my_heightPerson = JSON.parse(heightPersons);
      heightPerson.innerHTML = my_heightPerson + ' ' + 'cm';

      let massPersons = massPerson.innerHTML = JSON.stringify(data.results[2].mass)
      let my_massPerson = JSON.parse(massPersons);
      massPerson.innerHTML = my_massPerson + ' ' + 'kg';

      let hairPersons = hairPerson.innerHTML = JSON.stringify(data.results[2].hair_color)
      let my_hairPerson = JSON.parse(hairPersons);
      hairPerson.innerHTML = my_hairPerson;

      let skinPersons = skinPerson.innerHTML = JSON.stringify(data.results[2].skin_color)
      let my_skinPerson = JSON.parse(skinPersons);
      skinPerson.innerHTML = my_skinPerson;

      let eyePersons = eyePerson.innerHTML = JSON.stringify(data.results[2].eye_color)
      let my_eyePerson = JSON.parse(eyePersons);
      eyePerson.innerHTML = my_eyePerson;

      let yearPersons = yearPerson.innerHTML = JSON.stringify(data.results[2].birth_year)
      let my_yearPerson = JSON.parse(yearPersons);
      yearPerson.innerHTML = my_yearPerson;

      let genderPersons = genderPerson.innerHTML = JSON.stringify(data.results[2].gender)
