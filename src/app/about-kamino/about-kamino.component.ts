...
@Component({
  selector: 'app-about-kamino',
  templateUrl: '../about/about.component.html',
  styleUrls: ['../about/about.component.css']
})
export class AboutKaminoComponent implements OnInit {

  constructor() { }

  ngOnInit(): void {
    let request = 'https://swapi.dev/api/planets/10/';
    let residents = 'https://swapi.dev/api/people/?page=3';
    let residentsPageTwo = 'https://swapi.dev/api/people/?page=8';
    ...
    imgResidentOne.src = '../assets/img/resident/BobaFettMain2.webp';
    ...
    imgResidentTwo.src = '../assets/img/resident/Lama_Su.webp';
    ...
    imgResidentThree.src = '../assets/img/resident/TaunWe.webp';
    ...
    fetch(residentsPageTwo).then((response) => {
      ...
      let namePersonTwos = namePersonTwo.innerHTML = JSON.stringify(data.results[0].name)
      let my_namePersonTwo = JSON.parse(namePersonTwos);
      namePersonTwo.innerHTML = my_namePersonTwo;

      let heightPersonTwos = heightPersonTwo.innerHTML = JSON.stringify(data.results[0].height)
      let my_heightPersonTwo = JSON.parse(heightPersonTwos);
      heightPersonTwo.innerHTML = my_heightPersonTwo + ' ' + 'cm';

      let massPersonTwos = massPersonTwo.innerHTML = JSON.stringify(data.results[0].mass)
      let my_massPersonTwo = JSON.parse(massPersonTwos);
      massPersonTwo.innerHTML = my_massPersonTwo + ' ' + 'kg';

      let hairPersonTwos = hairPersonTwo.innerHTML = JSON.stringify(data.results[0].hair_color)
      let my_hairPersonTwo = JSON.parse(hairPersonTwos);
      hairPersonTwo.innerHTML = my_hairPersonTwo;

      let skinPersonTwos = skinPersonTwo.innerHTML = JSON.stringify(data.results[0].skin_color)
      let my_skinPersonTwo = JSON.parse(skinPersonTwos);
      skinPersonTwo.innerHTML = my_skinPersonTwo;

      let eyePersonTwos = eyePersonTwo.innerHTML = JSON.stringify(data.results[0].eye_color)
      let my_eyePersonTwo = JSON.parse(eyePersonTwos);
      eyePersonTwo.innerHTML = my_eyePersonTwo;

      let yearPersonTwos = yearPersonTwo.innerHTML = JSON.stringify(data.results[0].birth_year)
      let my_yearPersonTwo = JSON.parse(yearPersonTwos);
      yearPersonTwo.innerHTML = my_yearPersonTwo;

      let genderPersonTwos = genderPersonTwo.innerHTML = JSON.stringify(data.results[0].gender)
